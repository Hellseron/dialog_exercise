  ...
  <dialog>
     <div role="document">
       <!-- dialog content -->
          ...
          <button className="modal_opener" onClick={()=>setIsModalOpen(true)}>MODAL OPENING BUTTON</button>
        </div>


        <Dialog styles="customStyle" onClose={()=>setIsModalOpen(false)} open={isModalOpen}>
